...
IncompatibleGRF(DwordGrfID("F1250009"), "FIRS v5")
...
IncompatibleGRF(DwordGrfID("47472030"), "Australian Industries Set AuzInd")
...
IncompatibleGRF(DwordGrfID("4a448807"), "XIS Extreme Industry Set")
